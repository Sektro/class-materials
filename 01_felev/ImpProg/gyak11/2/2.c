...
int main()
{
    struct id {
        int i;
        double d;
    } lehet_itt_is_var1, lehet_itt_is_var2; // ez itt ugyanaz, mint: struct id lehet_itt_is_var1, lehet_itt_is_var2 tipusa id
    ...
    struct id s3; //stack, auto, adat elérés . : s3.i
    printf("%llu\n", sizeof(struct id));
    s3.i = 42;
    s3.d = .42;
    printf("%d\n", s3.i);
