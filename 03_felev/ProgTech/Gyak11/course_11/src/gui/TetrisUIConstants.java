...
// A konstansok tetszőlegesen megváltoztathatóak
public final class TetrisUIConstants  {
    ...
    public static final int SCORE_POS_Y = 330;
    ...
    public static final int PREVIEW_CENTER_X = 467;
    ...
    public static final Rectangle PREVIEW_RECTANGLE = new Rectangle(387, 47, 200, 200);
