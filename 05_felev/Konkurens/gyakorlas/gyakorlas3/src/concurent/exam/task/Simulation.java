...
public class Simulation {
    ...
    private static AtomicBoolean simulationOver = new AtomicBoolean(false);
    // TODO (Part 1) create collection for contracts with CONTRACT_MAX_NUMBER as limit
    private static Set<Contract> waitingRoom = new HashSet<>();
    ...
    private static void generateContract(){
        while (true) { // TODO (Part 1) simulationOver instead of true
            Contract contract = Contract.generateContract();
    ...
    private static void startWitcher(final Witcher witcher){
        while(true) { // TODO (Part 1) use simulationOver instead of true
